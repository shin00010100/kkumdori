    ...
    return (
        <div className="faq-board-container">
            ...
            <div className="faq-nav-buttons">
                <button onClick={() => navigate("/qnaboard")} className="faq-nav-button">Q&A</button>
                <button onClick={() => navigate("/onetooneboard")} className="faq-nav-button">1대1</button>
                <button onClick={() => navigate("/notice")} className="faq-nav-button">공지사항</button>
                <button onClick={() => navigate("/faqboard")} className="faq-nav-button">FAQ</button>
            </div>
